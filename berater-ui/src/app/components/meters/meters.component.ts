...
export class MetersComponent implements OnInit {
  ...
  showCreateModal(): void {
    alert('Neuer Zähler anlegen - Diese Funktion wird demnächst verfügbar sein.');
  }

  editMeter(meter: any): void {
    alert(`Zähler bearbeiten: ${meter.meterNumber} - Diese Funktion wird demnächst verfügbar sein.`);
  }
